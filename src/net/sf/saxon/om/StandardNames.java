...
public abstract class StandardNames {
    ...
    public static final int XSL_MATCH = XSL + 44;
    public static final int XSL_MATCHING_SUBSTRING = XSL + 45;
    public static final int XSL_MERGE = XSL + 46;
    public static final int XSL_MERGE_ACTION = XSL + 47;
    public static final int XSL_MERGE_KEY = XSL + 48;
    public static final int XSL_MERGE_SOURCE = XSL + 50;
    public static final int XSL_MESSAGE = XSL + 51;
    public static final int XSL_MODE = XSL + 52;
    public static final int XSL_NAMESPACE = XSL + 53;
    public static final int XSL_NAMESPACE_ALIAS = XSL + 54;
    public static final int XSL_NEXT_ITERATION = XSL + 55;
    public static final int XSL_NEXT_MATCH = XSL + 56;
    public static final int XSL_NON_MATCHING_SUBSTRING = XSL + 57;
    ...
    public static int getFingerprint(String uri, String localName) {
        return lookup.getOrDefault('{' + uri + '}' + localName, -1);
    }
    ...
    public final static StructuredQName SQ_XS_INVALID_NAME =
            new StructuredQName("xs", NamespaceConstant.SCHEMA, "invalid-name");
