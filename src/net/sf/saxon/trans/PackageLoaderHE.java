    ...
    private Pattern loadPattern(NodeInfo element) throws XPathException {
        ...
        if (loader == null) {
            ...
            if (pat instanceof GeneralNodePattern) {
                ...
                // Written this way for C# transpiler
            }
            return pat;
        }
    }
...
//            }
        ...
        eMap.put("fn", (loader, element) -> {
            ...
            if (e instanceof SystemFunctionCall) {
                ...
                loader.addCompletionAction(() -> ((SystemFunctionCall) e).allocateArgumentEvaluators(args));
        ...
        eMap.put("forEachGroup", (loader, element) -> {
            ...
            } else if ("breaking".equals(algorithmAtt)) {
                algo = ForEachGroup.GROUP_BREAKING_WHEN;
            } else {
            ...
            Expression select = loader.getExpressionWithRole(element, "select");
            Expression key;
            if (algo == ForEachGroup.GROUP_BY || algo == ForEachGroup.GROUP_ADJACENT || algo == ForEachGroup.GROUP_BREAKING_WHEN) {
