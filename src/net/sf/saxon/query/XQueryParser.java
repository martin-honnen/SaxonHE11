...
//            }
    ...
    private void sealNamespaces(/*@NotNull*/ List<String> namespacesToBeSealed, /*@NotNull*/ Configuration config) {
    ...
    protected Expression parseFLWORExpression() throws XPathException {
        ...
        while (true) {
            ...
            if (t.currentToken == Token.FOR || t.currentToken == Token.FOR_MEMBER) {
                ...
                t.setState(Tokenizer.BARE_NAME_STATE);
                nextToken();
                if (!(t.currentToken == Token.BY || isKeyword("by"))) {
...
//        }
    ...
    private void parseForClause(FLWORExpression flwor, List<Clause> clauseList) throws XPathException {
        ...
        do {
            ...
            int offset = t.currentTokenStartOffset;
            ForClause clause = forMember ? new ForMemberClause() : new ForClause();
