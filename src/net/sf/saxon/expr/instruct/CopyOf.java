        ...
        switch (kind) {
            ...
            case Type.ELEMENT: {
                ...
                if (copyLineNumbers) {
                    ...
                    pipe.setCopyInformee(element -> copier.notifyElementNode(element));
                }
            ...
            case Type.DOCUMENT: {
                ...
                if (copyLineNumbers) {
                    ...
                    //noinspection Convert2MethodRef
                    val.getPipelineConfiguration().setCopyInformee(element -> copier.notifyElementNode(element));
                ...
                ItemMappingFunction copier = ItemMapper.of(item -> {
                    if (item instanceof NodeInfo) {
                        ...
                        if (isXSLT && copyAccumulators) {
                            ...
                            AccumulatorManager am = ((XsltController) context.getController()).getAccumulatorManager();
