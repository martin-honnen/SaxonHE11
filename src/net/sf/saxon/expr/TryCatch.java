...
public class TryCatch extends Expression {
    ...
    public SequenceIterator iterate(XPathContext c) throws XPathException {
        ...
        c1.setErrorReporter(new FilteringErrorReporter(c.getErrorReporter(), catchClauses));
        try {
    ...
    public void process(Outputter output, XPathContext context) throws XPathException {
        ...
        c1.createThreadManager();
        c1.setErrorReporter(new FilteringErrorReporter(context.getErrorReporter(), catchClauses));
            ...
            if (err.isGlobalError()) {
                ...
                for (CatchClause clause : catchClauses) {
                    if (clause.nameTest.matches(code)) {
                        ...
                        SequenceTool.supply(((GroundedValue) v).iterate(), (ItemConsumer<? super Item>) item -> output.append(item));
                        return;
                    }
                }
            }
